...
function sendRequest(url, param, callBack, method){ //url: 목적지, param: 전달데이터, callBack: 돌아올곳, method: 전송방식
	...
	//만약 "POST" type을 보내려 한다면, 요청(request)에 MIME type을 설정 해야 한다. 예를 들자면 send()를 호출 하기 전에 아래와 같은 형태로 send()로 보낼 쿼리를 이용해야 한다.
